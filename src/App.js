...
// import HoodiesCart from "./components/pages/Hoodies/Cart/HoodiesCart";
...
//       <Router>
//         <Navbar />
//         {isCartOpen && <HoodiesCart toggleCart={toggleCart} />}
//         <Routes>
//           <Route path="/" element={<Home />} />
//           <Route
//             path="/oversized-page1"
//             element={<OversizedT1 toggleCart={toggleCart} />}
//           />
//           <Route
//             path="/oversized-page2"
//             element={<OversizedT2 toggleCart={toggleCart} />}
//           />
...
//           <Route
//             path="/hoodies/:id"
//             element={<HoodiesMoreData toggleCart={toggleCart} />}
//           />
...
function App() {
  ...
  return (
    <div className="App">
      <Router>
        <Navbar isOpen={isCartOpen} toggleCart={toggleCart} />
        <HoodiesCart isOpen={isCartOpen} toggleCart={toggleCart} />
        <Routes>
          ...
          <Route path="/oversized-basics/:id" element={<BasicsMoreData/>} />
          <Route path="/regular-tees" element={<Regular/>} />
          <Route path="/regular-tees/:id" element={<RegularMoreData isOpen={isCartOpen} toggleCart={toggleCart}/>} />
          <Route path="/hoodies" element={<Hoodies/>} />
          <Route path="/hoodies/:id" element={<HoodiesMoreData isOpen={isCartOpen} toggleCart={toggleCart} />} />
          <Route path="/refund" element={<Refunding/>} />
